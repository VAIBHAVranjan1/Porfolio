...
const NavBar = () => {
  ...
  return (
    <nav className={cn("fixed w-full z-40 transition-all duration-300", isScrolled ? "p-3 bg-background/80 background-blur-md shadow-xs" : "p-5")}>
        <div className='container flex items-center justify-between'>
            ...
            <button onClick={() => setIsMenu((prev) => !prev)} className='md:hidden p-2 text-foreground z-50'
